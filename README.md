...
The private source contract is fixed to `Nytshift/nytshift-android`, branch `main`, workflow `android-ci`, and source commit `34b977afc7435d7baccaf093581c4b6ed20d2587`. Both public verification layers require exactly 338 JVM tests, 39 Android tests, and 46 reviewed screenshot references. The reviewed source validator at that commit is `stage_signed_preview_release.py`, SHA-256 `7e1193b38d8588bbc9f7e2c1c5806008d4d18e3b3261deead27accdae53e4475`.
